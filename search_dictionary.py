...
class Dict:
    ...
    Atribute:
        ...
        words (dict): dictionarul de cuvinte, perechi de stringuri
                      word: translation
        total (int):  numarul total de definitii, sau cuvinte
    Metode:
        __init__(self, name='Dictionar Ro-En, initial_words=None)
...
def main():
    ...
    d.display()
    print(d.search('zi'))
    print(d.search('eveniment'))  # ridica o exceptie WordNotFindError
